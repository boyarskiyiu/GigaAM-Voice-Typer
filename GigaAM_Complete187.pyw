...
# -*- coding: utf-8 -*-
"""
GigaAM Complete — Версия 1.8.7 (15.04.2026)
(c) Боярский Игорь Юрьевич, 2026

- Крупные читаемые шрифты во всём интерфейсе
- Кнопки шириной 16, шрифт 10pt – текст влезает идеально
- Окно 800x760, точная геометрия без наложений
"""
...
# ----------------------------------------------------------------------
lock_file = os.path.join(tempfile.gettempdir(), "gigaam_187.lock")
...
class GigaAMApp:
    ...
    # ------------------------------------------------------------------
    # Вспомогательные методы (без изменений, только шрифты в диалогах увеличены)
    # ------------------------------------------------------------------
