...
# -*- coding: utf-8 -*-
"""
GigaAM Complete — Версия 1.9.4 (16.04.2026)
(c) Боярский Игорь Юрьевич, 2026

- Полностью переработана геометрия шапки (высота 220), версия под заголовком
- Кнопки шириной 17, окно 750x750, идеальная компоновка
...
# ----------------------------------------------------------------------
lock_file = os.path.join(tempfile.gettempdir(), "gigaam_194.lock")
...
class GigaAMApp:
    ...
    def create_widgets(self):
        # Шапка (высота 220) – все строки разнесены
        ...
        header = tk.Frame(header_frame, bg="#2c3e50", height=220, relief=tk.RAISED, borderwidth=3)
        ...
        tk.Label(right, text="📞 +7 905 570-28-04", font=("Segoe UI", 11),
                 bg="#2c3e50", fg="#ecf0f1").place(relx=0.98, y=14, anchor="ne")
        tk.Label(right, text="✉️ boyarskiyiu@yandex.ru", font=("Segoe UI", 11),
                 bg="#2c3e50", fg="#ecf0f1").place(relx=0.98, y=44, anchor="ne")
        tk.Label(right, text="© 2026 Боярский И.Ю.\nВсе права защищены.",
                 font=("Segoe UI", 11, "bold"), bg="#2c3e50", fg="#f1c40f", justify=tk.RIGHT).place(relx=0.98, y=82, anchor="ne")
        ...
        # Кнопки – ширина 17, шрифт 10pt bold
