...
# -*- coding: utf-8 -*-
"""
GigaAM Complete — Версия 1.9.6 (16.04.2026)
(c) Боярский Игорь Юрьевич, 2026

- Номер версии перенесён в правый верхний угол (не перекрывает заголовок)
...
# ----------------------------------------------------------------------
lock_file = os.path.join(tempfile.gettempdir(), "gigaam_196.lock")
...
class GigaAMApp:
    ...
    def create_widgets(self):
        ...
        tk.Label(left, text=f"Версия {CURRENT_VERSION} (16.04.2026)", font=("Segoe UI", 10),
                 bg="#2c3e50", fg="#bdc3c7").place(relx=1.0, x=-10, y=6, anchor="ne")
        # Разработчик
