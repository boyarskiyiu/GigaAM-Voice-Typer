...
# -*- coding: utf-8 -*-
"""
GigaAM Complete — Версия 322.0 (15.04.2026)
(c) Боярский Игорь Юрьевич, 2026

- Добавлено подробное логирование проверки обновлений
- Исправлена возможная ошибка при сравнении версий
"""
...
# ----------------------------------------------------------------------
lock_file = os.path.join(tempfile.gettempdir(), "gigaam_322.lock")
...
class GigaAMApp:
    ...
    def init_background(self):
        self.log("="*60)
        self.log(f"GigaAM Complete v{CURRENT_VERSION} — с детальным логом обновлений")
