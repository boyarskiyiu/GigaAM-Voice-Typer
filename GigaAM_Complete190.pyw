...
# -*- coding: utf-8 -*-
"""
GigaAM Complete — Версия 1.9.0 (16.04.2026)
(c) Боярский Игорь Юрьевич, 2026

- Кнопки шириной 17, правая граница окна вплотную
- Исправлено наложение версии на заголовок
...
# ----------------------------------------------------------------------
lock_file = os.path.join(tempfile.gettempdir(), "gigaam_190.lock")
...
class GigaAMApp:
    ...
    def create_widgets(self):
        ...
        tk.Label(left, text=f"Версия {CURRENT_VERSION} (16.04.2026)", font=("Segoe UI", 10),
                 bg="#2c3e50", fg="#bdc3c7").place(x=220, y=10)
