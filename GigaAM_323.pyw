...
# -*- coding: utf-8 -*-
"""
GigaAM Complete — Версия 323.0 (15.04.2026)
(c) Боярский Игорь Юрьевич, 2026

- Устойчивая проверка обновлений (повторные попытки при сетевых ошибках)
- Понятные сообщения при отсутствии интернета
"""
...
# ----------------------------------------------------------------------
lock_file = os.path.join(tempfile.gettempdir(), "gigaam_323.lock")
...
class GigaAMApp:
    ...
    def init_background(self):
        self.log("="*60)
        self.log(f"GigaAM Complete v{CURRENT_VERSION} — устойчивая проверка обновлений")
