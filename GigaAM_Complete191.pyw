...
# -*- coding: utf-8 -*-
"""
GigaAM Complete — Версия 1.9.1 (16.04.2026)
(c) Боярский Игорь Юрьевич, 2026

- Исправлено положение версии (теперь справа от заголовка)
- Кнопки шириной 17, окно 750x750, правая граница вплотную
...
# ----------------------------------------------------------------------
lock_file = os.path.join(tempfile.gettempdir(), "gigaam_191.lock")
...
class GigaAMApp:
    ...
    def create_widgets(self):
        ...
        # Заголовок и версия (версия справа, не перекрывает)
        ...
        tk.Label(left, text=f"Версия {CURRENT_VERSION} (16.04.2026)", font=("Segoe UI", 10),
                 bg="#2c3e50", fg="#bdc3c7").place(x=240, y=6)
