...
# -*- coding: utf-8 -*-
"""
GigaAM Complete — Версия 1.9.3 (16.04.2026)
(c) Боярский Игорь Юрьевич, 2026

- Версия перенесена на отдельную строку (y=30) – не перекрывает заголовок
...
# ----------------------------------------------------------------------
lock_file = os.path.join(tempfile.gettempdir(), "gigaam_193.lock")
