...
# -*- coding: utf-8 -*-
"""
GigaAM Complete — Версия 1.8.5 (15.04.2026)
(c) Боярский Игорь Юрьевич, 2026

- Кнопки разных цветов: пауза оранж/зел, исправить син, свернуть сер, обновить зел, о программе т-син
- Компактное окно 750x730, крупные читаемые шрифты
- Автоустановка зависимостей, Яндекс.Спеллер, автообновление с GitHub
"""
...
# ----------------------------------------------------------------------
lock_file = os.path.join(tempfile.gettempdir(), "gigaam_185.lock")
...
class GigaAMApp:
    ...
    def create_widgets(self):
        ...
        tk.Label(left, text=mic_desc, font=("Segoe UI", 10), bg="#2c3e50", fg="#bdc3c7",
                 justify=tk.LEFT).place(x=6, y=158)
        ...
        # Кнопки – ширина 14, шрифт 9pt bold, разные цвета
    ...
    def fix_last_phrase(self):
        ...
        btn_save = tk.Button(dialog, text="Сохранить", command=lambda: self._save_fix(dialog, correct_entry.get().strip()),
                             bg="#4caf50", fg="white", width=14, font=("Segoe UI", 9, "bold"))
