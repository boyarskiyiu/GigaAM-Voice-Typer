...
# -*- coding: utf-8 -*-
"""
GigaAM Complete — Версия 321.0 (15.04.2026)
(c) Боярский Игорь Юрьевич, 2026

- Изменён дизайн кнопки «Обновить» (синяя с молнией)
...
# ----------------------------------------------------------------------
lock_file = os.path.join(tempfile.gettempdir(), "gigaam_321.lock")
...
class GigaAMApp:
    ...
    def init_background(self):
        self.log("="*60)
        self.log(f"GigaAM Complete v{CURRENT_VERSION} — новый дизайн кнопки обновления")
