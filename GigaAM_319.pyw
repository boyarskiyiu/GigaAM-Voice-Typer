...
# -*- coding: utf-8 -*-
"""
GigaAM Complete — ФИНАЛЬНАЯ ВЕРСИЯ 319.0 (14.04.2026)
(c) Боярский Игорь Юрьевич, 2026

- Компактный интерфейс 820x730, всё на виду
- Автоматический микрофон, автокалибровка, автоустановка
- Яндекс.Спеллер, многопоточность, длинные фразы без потерь
"""
...
# ----------------------------------------------------------------------
lock_file = os.path.join(tempfile.gettempdir(), "gigaam_319.lock")
...
class GigaAMApp:
    ...
    def create_widgets(self):
        ...
        tk.Label(left, text="Версия 319.0 (14.04.2026)", font=("Segoe UI", 9),
    ...
    def check_updates(self):
        messagebox.showinfo("Обновление", "Проверка обновлений пока не настроена.\n"
                                         "Следите за новыми версиями в репозитории на GitHub!")
    ...
    def init_background(self):
        self.log("="*60)
        self.log("GigaAM Complete v319.0 — финальная версия")
