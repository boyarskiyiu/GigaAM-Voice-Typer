...
# -*- coding: utf-8 -*-
"""
GigaAM Complete — Версия 320.0 (15.04.2026)
(c) Боярский Игорь Юрьевич, 2026

- Добавлена проверка обновлений через GitHub
- Все функции версии 319.0 сохранены
"""
...
# ----------------------------------------------------------------------
lock_file = os.path.join(tempfile.gettempdir(), "gigaam_320.lock")
...
class GigaAMApp:
    ...
    def compare_versions(self, v1, v2):
        """Сравнивает две версии (например, '320.0' и '321.0')"""
        def normalize(v):
    ...
    def init_background(self):
        self.log("="*60)
        self.log(f"GigaAM Complete v{CURRENT_VERSION} — с автообновлением")
