...
# -*- coding: utf-8 -*-
"""
GigaAM Complete — Версия 1.8.9 (16.04.2026)
(c) Боярский Игорь Юрьевич, 2026

- Окно сужено до 740x750, правая граница вплотную к кнопкам
...
# ----------------------------------------------------------------------
lock_file = os.path.join(tempfile.gettempdir(), "gigaam_189.lock")
...
if os.path.exists(lock_file):
    try:
        ...
        if is_process_running(old_pid):
            print("⚠️ Программа уже запущена. Закройте предыдущий экпемпляр.")
            sys.exit(1)
        else:
            os.unlink(lock_file)
    except:
...
class GigaAMApp:
    ...
    def create_widgets(self):
        ...
        # Кнопки – ширина 16, шрифт 10pt bold, отступы минимальные
