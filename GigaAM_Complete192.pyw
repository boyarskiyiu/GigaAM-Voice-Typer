...
# -*- coding: utf-8 -*-
"""
GigaAM Complete — Версия 1.9.2 (16.04.2026)
(c) Боярский Игорь Юрьевич, 2026

- Номер версии опущен чуть ниже (y=10), больше не перекрывает заголовок
- Кнопки шириной 17, окно 750x750, идеальная геометрия
...
# ----------------------------------------------------------------------
lock_file = os.path.join(tempfile.gettempdir(), "gigaam_192.lock")
...
class GigaAMApp:
    ...
    def create_widgets(self):
        ...
        # Заголовок и версия (версия опущена на y=10)
        ...
        tk.Label(left, text=mic_desc, font=("Segoe UI", 10), bg="#2c3e50", fg="#bdc3c7",
                 justify=tk.LEFT).place(x=8, y=172)
