...
# -*- coding: utf-8 -*-
"""
GigaAM Complete — Версия 1.9.5 (16.04.2026)
(c) Боярский Игорь Юрьевич, 2026

- Полностью переработана геометрия шапки (высота 230), все элементы на местах
...
# ----------------------------------------------------------------------
lock_file = os.path.join(tempfile.gettempdir(), "gigaam_195.lock")
...
class GigaAMApp:
    ...
    def create_widgets(self):
        # Шапка (высота 230) – все координаты выверены
        ...
        header = tk.Frame(header_frame, bg="#2c3e50", height=230, relief=tk.RAISED, borderwidth=3)
        ...
        tk.Label(right, text="© 2026 Боярский И.Ю.\nВсе права защищены.",
                 font=("Segoe UI", 11, "bold"), bg="#2c3e50", fg="#f1c40f", justify=tk.RIGHT).place(relx=0.98, y=84, anchor="ne")
