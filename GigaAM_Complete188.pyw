...
# -*- coding: utf-8 -*-
"""
GigaAM Complete — Версия 1.8.8 (15.04.2026)
(c) Боярский Игорь Юрьевич, 2026

- Окно сужено до 760x750, правая граница выровнена по кнопкам
...
# ----------------------------------------------------------------------
lock_file = os.path.join(tempfile.gettempdir(), "gigaam_188.lock")
...
class GigaAMApp:
    ...
    def create_widgets(self):
        ...
        # Кнопки – ширина 16, шрифт 10pt bold, отступы уменьшены
